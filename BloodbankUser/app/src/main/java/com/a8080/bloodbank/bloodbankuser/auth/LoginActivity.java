...
import com.a8080.bloodbank.bloodbankuser.MainActivity;
...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL = getString(R.string.protocol) + "" + getString(R.string.domain) + "" + getString(R.string.baseUrl) + "checksignup.php";
...
//                            updateUI(STATE_SIGNIN_SUCCESS, user);
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            try {
                                                if (response.equals("true")) {
                                                    ...
                                                    editor.putBoolean("FLAG", Boolean.TRUE);
                                                    editor.commit();

                                                    startActivity(new Intent(LoginActivity.this, ProfileActivity.class));
                                                    finish();
                                                } else if (response.equals("User is already exist!")) {
                                                    startActivity(new Intent(LoginActivity.this, ProfileActivity.class));
                                                    finish();
                                                }
                                            } catch (Exception e) {
                            ...
                            queue.addToRequestQueue(LoginActivity.this, stringRequest);
